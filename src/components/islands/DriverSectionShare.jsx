...
export default function DriverSectionShare({ section, driverRef, driverName, payload }) {
  ...
  return (
    <div className="dv-share">
      <button type="button" className="cmp-foot-btn cmp-foot-btn-primary" onClick={openShare} title="Export a share image"><Icon name="share" size={14} /> Share image</button>

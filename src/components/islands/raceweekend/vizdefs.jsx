...
// Each def: { key, title, desc, src, render(args) } where args =
...
const RACE_VIZ = [
  { key: 'trace', title: 'Race trace', src: 'laps["LapTime"] cumulative + track_status',
    desc: 'Gap to leader lap by lap — pit stops step the line, SC/VSC bands explain the resets. Use the driver filter above.',
    render: (a) => <RaceTrace R={a.R} ctx={a.ctx} sel={a.sel} /> },
  { key: 'positions', title: 'Position changes', src: 'laps["Position"] per lap',
  ...
  { key: 'stints', title: 'Tyre strategy', src: 'laps["Compound","Stint","TyreLife"]',
    desc: 'Every stint as a compound-coloured bar in finish order. White ticks are pit stops.',
    render: (a) => <StintChart R={a.R} ctx={a.ctx} /> },
  { key: 'pits', title: 'Pit stop timeline', src: 'laps["PitInTime","PitOutTime"]',
  ...
  { key: 'deg', title: 'Tyre degradation', src: 'laps + TyreLife, green-flag filter',
  ...
  { key: 'teampace', title: 'Team race pace', src: 'laps["LapTime"] quartiles by team',
  ...
  { key: 'overtakes', title: 'Overtake matrix', src: 'laps["Position"] deltas',
  ...
  { key: 'undercut', title: 'Undercut calculator', src: 'laps around PitInTime windows',
  ...
  { key: 'racecontrol', title: 'Race control feed', src: 'session.race_control_messages',
...
const QUALI_VIZ = [
  { key: 'ladder', title: 'Gap to pole ladder', src: 'laps.pick_fastest() per driver',
  ...
  { key: 'sectors', title: 'Sector battle', src: 'laps["Sector1/2/3Time"]',
  ...
  { key: 'dominance', title: 'Track dominance map', src: 'telemetry distance-sliced mini-sectors',
  ...
  { key: 'poletel', title: 'Pole lap telemetry', src: 'car_data["Speed"] + computed delta',
  ...
  { key: 'progression', title: 'Q1→Q3 progression', src: 'laps per Q segment',
  ...
  { key: 'theoretical', title: 'Theoretical best', src: 'best-lap sectors vs actual',
  ...
  { key: 'evolution', title: 'Track evolution', src: 'laps["LapStartTime","LapTime"]',
  ...
  { key: 'speedtrap', title: 'Speed trap ranking', src: 'laps["SpeedST"]',
...
const SQ_VIZ = [
  { key: 'ladder', title: 'Gap to sprint pole', src: 'laps.pick_fastest() per driver',
...
const SPRINT_VIZ = [
  { key: 'trace', title: 'Sprint trace', src: 'laps["LapTime"] cumulative',
    desc: 'Gap to leader across the sprint — short race, small gaps, every move visible.',
    render: (a) => <RaceTrace R={a.R} ctx={a.ctx} sel={a.sel} /> },
  { key: 'stints', title: 'Tyre choice', src: 'laps["Compound","Stint"]',
    desc: 'Compound picks across the sprint field.',
    render: (a) => <StintChart R={a.R} ctx={a.ctx} /> },
  { key: 'lap1', title: 'Lap 1 gains & losses', src: 'grid vs P after L1',
    desc: 'Start reaction and lap-1 places gained across the sprint field.',
    render: (a) => <Lap1Chart R={a.R} ctx={a.ctx} /> },
  { key: 'sprintvsgp', title: 'Sprint vs GP pace', src: 'sprint laps vs race laps, fuel-corrected',
...
const FP_VIZ = [
  { key: 'lapmap', title: 'Session lap map', src: 'laps + Compound over session time',
  ...
  { key: 'longrun', title: 'Long-run pace', src: 'stint detection on laps, len ≥ 6',
  ...
  { key: 'trap', title: 'Speed trap', src: 'laps["SpeedST"]',
  ...
  { key: 'compoundoffset', title: 'Compound offset', src: 'paired long-run stints',
  ...
  { key: 'simvsrace', title: 'Sim vs race', src: 'FP long runs vs race pace',

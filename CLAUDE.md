...
- `public/images/logo/` - brand logo art (cropped from the source kit): `f1gures-wordmark-{dark,light}.png` (transparent plate wordmark; the nav swaps by theme, the trivia share card draws the dark one) + `icon-{192,512}.png` (maskable app icons referenced by the manifest).
